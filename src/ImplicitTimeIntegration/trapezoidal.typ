...
The *Trapezoidal Rule* method approximates the integral in @eq_integrated_ode and @eq_integrated_mass_ode by the trapezoidal rule (@eq_numerical_integration_trapezoid):
