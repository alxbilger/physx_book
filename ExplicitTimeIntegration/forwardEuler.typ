...
$
d/(d t) mat(delim:"[", #position (t); #velocity (t)) approx  1/(Delta t) (mat(delim:"[", #position (t+ Delta t); #velocity (t + Delta t)) - mat(delim:"[", #position (t); #velocity (t)) )
$
...
M(velocity(t+stepsize)-velocity(t)))
=
mat(delim:"[",
velocity(t);
...
mat(delim:"[", #position _n& + Delta t thick #velocity _n; #velocity _n& + Delta t thick M^(-1)F(#position _n, #velocity _n))
$